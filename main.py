...
with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
    # starting time here
    CLOSED_EYE_THRESHOLD = 5.5  # Adjust this value as needed
    ALARM_DURATION = 2  # Alarm duration in seconds
    eye_open = True
        ...
        if results.multi_face_landmarks:
            ...
            if ratio > 4.1:
                ...
                if eye_closed_start_time is not None:
                    ...
                    if eye_closed_duration >= ALARM_DURATION:
                        TIREDNESS_COUNT += 1
                        eye_closed_start_time = None
                        print("Alarm: Tiredness detected!!", TIREDNESS_COUNT)
                        utils.colorBackgroundText(frame, f'Alarm !! Tiredness detected!!', FONTS, 1.7,
                                                  (int(frame_height / 2), 100), 2,
                                                  utils.YELLOW,
                                                  pad_x=6, pad_y=6, )
